            ...
            <ThemeProvider theme={darkTheme}>
                <div className="search">
                    <TextField
                        ...
                        InputProps={{
                            style: { color: 'white', fontWeight:'bolder' }, // колір тексту
                        }}
                        InputLabelProps={{
                            style: { color: 'white' }, // колір label
                        }}
                    />
                    <Button
                        onClick={fetchSearch}
                ...
                >
                    <Tab style={{ width: "50%", color: 'white', fontWeight: 'semibold' }} label="Search Movies" />
                    <Tab style={{ width: "50%", color: 'white', fontWeight: 'semibold' }} label="Search TV Series" />
                </Tabs>
            </ThemeProvider>
