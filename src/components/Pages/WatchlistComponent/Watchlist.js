...
import { getWatchlistFromS3 } from "../../../services/aws_service"
...
const Watchlist = () => {
    ...
    useEffect(() => {
        ...
        const syncWithS3 = async () => {
            try {
                const watchlistFromS3 = await getWatchlistFromS3();
                localStorage.setItem("watchlist", JSON.stringify(watchlistFromS3));
        ...
        const handler = () => syncWithS3(); // оновлення з AWS при події
